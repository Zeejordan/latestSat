                    ...
                    <View style={styles.subContainer}>
                        <View style={styles.firstBox}>
                            <TouchableOpacity onPress={() => navigation.goBack()}>
                                <AntDesign name='left' color={"black"} style={styles.backIcon} />
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => navigation.goBack()}>
                                <Text style={styles.changeEmailText}>{t('changeEmail')}</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <View>
                            {loadingVerify ? (
                                <ActivityIndicator color={COLORS.blueColor} size={"large"} style={styles.verifyLoader} />
                            ) : (
                                <TouchableOpacity
                                    style={[
                            ...
                            {loadingResend ? (
                                <ActivityIndicator color={COLORS.blueColor} size={"large"} style={styles.resendLoader} />
                            ) : (
